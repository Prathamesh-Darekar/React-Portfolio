        ...
        <section className="wrapper">
            ...
            <div id="edu-wrapper">
                <div id="degree" className='details'>
                    ...
                    <h4>Bhandarkars Arts and Science College Kundapura</h4>
                    <p style={{color:'#009688'}}>2022-present</p>
                    <p>Studying BCA at Bhandarkars' Arts and Science College in Kundapura has been an enriching experience, particularly in exploring diverse programming languages. From mastering the basic concepts of languages like C, Java, Python, and JavaScript to delving into essential Data Structure concepts.</p>
                </div>
                <div id="degree" className='details'>
                    <h3>Commerce with Computer science</h3>
                    <h4>Government College Kundapura <span style={{color:'#009688',fontWeight:"600"}}>- 96%</span></h4>
            ...
            <div id="certification" style={{position:'absolute',bottom:'70px'}}></div>
        </section>
    )
}
